...
Vector3d triangulateFeatureNonLin(const Matrix3d& R,
    							  const Vector3d& t,
...
bool depthFromTriangulationExact(const Matrix3d& R_r_c,
...
double reprojError(const Vector3d& f1, const Vector3d& f2, double error_multiplier2);
...
double sampsonusError(const Vector2d &v2Dash, const Matrix3d& m3Essential, const Vector2d& v2);
...
inline void frameJac_xyz2uv(const Vector3d & xyz,
